      ...
      <div className="flex flex-col items-center justify-center gap-10 py-5">
        {INFO.map((info, id) => (
          ...
          >
            ...
            <div className="lg:gap-15 grid min-w-[500px] grid-cols-3 justify-center gap-12 rounded-lg border-b border-t border-[#26292e] bg-[#191e24] p-5 md:px-8 md:py-9 lg:flex">
